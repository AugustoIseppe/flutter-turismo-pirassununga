...
class PizzariasPage extends StatefulWidget {
  const PizzariasPage({super.key});

  @override
  State<PizzariasPage> createState() => _PizzariasPageState();
}

class _PizzariasPageState extends State<PizzariasPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          FutureBuilder(
            future: _secturPiraService.listarPizzaria(),
