...
class LanchonetesPage extends StatefulWidget {
  const LanchonetesPage({super.key});

  @override
  State<LanchonetesPage> createState() => _LanchonetesPageState();
}

class _LanchonetesPageState extends State<LanchonetesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          FutureBuilder(
            future: _secturPiraService.listarLanchonete(),
