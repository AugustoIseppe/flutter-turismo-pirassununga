...
class HospegademPage extends StatefulWidget {
  const HospegademPage({super.key});

  @override
  State<HospegademPage> createState() => _HospegademPageState();
}

class _HospegademPageState extends State<HospegademPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          FutureBuilder<List<InfosLocal>>(
            future: _secturPiraService.listarHospedagem(),
